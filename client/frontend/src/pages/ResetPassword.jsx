...
const ResetPassword = () => {
// function that will send the password reset OTP /to make API call we need backend URL

const{backendUrl} = useContext(AppContent)
//  this API request we will send the cookies 
...
axios.defaults.withCredentials = true
  ...
  // to hide one form, only visible one form at once time and then if one form subhit then another form appear

  const[isEmailSent, setIsEmailSent] = useState('');
  // isEmailSent-- make it true whenever we will send the OTP to reset the password 
  ...
  //   e.preventDefault();
  //   // yahan aage OTP bhejne ka logic aayega
  // }
  ...
  // DELETE number by backspace
    ...
    const onSubmitOTP = async (e)=>{
      e.preventDefault();
// create the array of OTP that is entered in different input field so we will add 
  const otpArray = inputRefs.current.map(e => e.value)

      // join all these element from this array
